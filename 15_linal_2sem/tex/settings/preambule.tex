...
\newcommand*\koz{\includegraphics{koz.pdf}}
\newcommand{\F}{\mathbb{F}}  
\newcommand{\Sp}[2]{(\vc{#1}, \vc{#2})}
\newcommand{\norm}[1]{\|\vc{#1}\|}
\newcommand{\ten}{\mathbb{T}}
\newcommand{\numt}{T_{i_1, \dots, i_p}^{j_1, \dots, j_q}}
...
\fancyhead[RE,LO]{{Ф\raisebox{-1.5pt}{и}з\TeX}}
\fancyhead[LE,RO]{ЛинАл}
\fancyhead[CO,CE]{\leftmark}
% \fancyhead[CO,CE]{\rightmark}
% \fancyhead[CE,CO]{\tiny \leftmark}
\fancyfoot[CE,CO]{\textbf{\textit{\thepage}}}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
